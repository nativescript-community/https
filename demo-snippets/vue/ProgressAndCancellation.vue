        ...
        <GridLayout rows="auto,*">
            ...
            <ScrollView row="1">
                <StackLayout class="p-20">
                    ...
                    <Button text="Download with Progress" @tap="testDownloadProgress" class="btn btn-primary" />
                    <Button text="Upload with Progress" @tap="testUploadProgress" class="btn btn-primary" />
                    <Button text="Multiple Downloads with Progress" @tap="testMultipleProgress" class="btn btn-primary" />
                    ...
                    <Button text="Cancel Multiple Requests" @tap="testCancelMultiple" class="btn btn-primary" />
                    <Button text="Cancel All Requests" @tap="testCancelAll" class="btn btn-primary" />
                    <Button text="Cancel During Progress" @tap="testCancelDuringProgress" class="btn btn-primary" />
                    
                    <!-- Advanced Cancellation -->
                    <Label class="h4 mt-20" text="Advanced Cancellation Scenarios" />
                    <Button text="Cancel Before Completion" @tap="testCancelBeforeCompletion" class="btn btn-primary" />
                    <Button text="Cancel After Completion (Should Fail)" @tap="testCancelAfterCompletion" class="btn btn-primary" />
                    <Button text="Cancel Non-Existent Request" @tap="testCancelNonExistent" class="btn btn-primary" />
                    
                    <!-- Timeout Tests -->
                    <Label class="h4 mt-20" text="Timeout Tests" />
                    <Button text="Request with Short Timeout" @tap="testShortTimeout" class="btn btn-primary" />
                    <Button text="Request with Long Timeout" @tap="testLongTimeout" class="btn btn-primary" />
                    <Button text="Timeout vs Cancellation" @tap="testTimeoutVsCancellation" class="btn btn-primary" />
                    
                    <!-- createRequest Tests -->
                    <Label class="h4 mt-20" text="createRequest API" />
                    <Button text="createRequest() with run()" @tap="testCreateRequest" class="btn btn-primary" />
                    <Button text="createRequest() with cancel()" @tap="testCreateRequestCancel" class="btn btn-primary" />
                    <Button text="createRequest() with Progress" @tap="testCreateRequestProgress" class="btn btn-primary" />
